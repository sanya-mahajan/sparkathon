...
with col1:
    ...
    create_redeem_option("💸 Discounts on Future Purchases", "images/Discount.png", "Save more on your next purchase!",
    ...
    create_redeem_option("🎁 Gift Coupons", "images/giftcoupons.png", "Gift yourself or someone special!",
    ...
    create_redeem_option("❤️ Donate Your Points", "images/donate.png", "Make a difference with your points!",
...
with col2:
    ...
    create_redeem_option("💰 Cashback Offers", "images/cashback.png", "Get cash back into your wallet!",
    ...
    create_redeem_option("🆓 Free Products", "images/free.png", "Get products for free!",
    ...
    create_redeem_option("🎟️ Exclusive Event Access", "images/events.png", "Attend special events!",
